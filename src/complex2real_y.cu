...
__global__ void complex2real_y (cufftComplex *y1_device_f, double *y1_device, cufftComplex *y2_device_f,
        double *y2_device, cufftComplex *y3_device_f, double *y3_device, int Nx, int Ny, int Nz)
{
