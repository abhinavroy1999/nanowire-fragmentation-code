...
__global__ void compute_y (cufftComplex *y1_device_f, cufftComplex *y2_device_f, cufftComplex *y3_device_f,
        cufftComplex *r_device_f, double *kx_vect_device, double *ky_vect_device, double *kz_vect_device, int Nx, int Ny, int Nz)
{
